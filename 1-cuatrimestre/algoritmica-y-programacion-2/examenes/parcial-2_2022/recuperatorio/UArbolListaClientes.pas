unit UArbolListaClientes;

Interface 

uses UClientes,UListaClientes;
...
procedure meterArbol(var arbol:TArbol; const e:TLista);

function vaciaArbol(arbol:TArbol):boolean;

function buscarArbol(arbol:TArbol; const e:TLista):TArbol;

procedure eliminarArbol(var arbol:TArbol; e:TLista);
...
procedure buscarEliminar(arbol: TArbol; const e: TLista; var nodoEliminar, nodoPadre: TArbol);
begin
    if (arbol = nil) then
    begin
        nodoEliminar := nil;
