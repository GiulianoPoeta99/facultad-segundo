...
type 
    TElemento= record
        dni,nroPadron: longint;
        apellido,nombre,direccion: string;
    end; 
...
begin
    ...
    while(lista <> nil) do
    begin
        writeln('Nombre: ',lista^.info.nombre,' ',lista^.info.apellido);
        writeln('DNI: ',lista^.info.dni);
        writeln('Direccion: ',lista^.info.direccion);
        writeln('Nro. Padron: ',lista^.info.nroPadron);
        writeln('================================');
