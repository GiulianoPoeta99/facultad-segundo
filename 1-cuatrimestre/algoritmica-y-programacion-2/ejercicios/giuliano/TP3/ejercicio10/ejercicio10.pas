{
    10. Realizar un programa en Pascal, para resolver el siguiente problema:
    ...
    NOTA: los datos vienen ordenados por día y por tipo de mesa y el programa debe estar
    modulado.
}
program ejercicio10;
uses crt;
